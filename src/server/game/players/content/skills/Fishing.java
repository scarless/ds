...
public class Fishing extends SkillHandler {
	...
	private static int[][] data = {
			{ 1, 1, 303, -1, 317, 5, 621, 321, 15, 30 }, // SHRIMP + ANCHOVIES
			{ 2, 5, 309, 313, 327, 10, 622, 345, 10, 30 }, // SARDINE + HERRING
			{ 3, 16, 305, -1, 353, 20, 620, -1, -1, -1 }, // MACKEREL
			{ 4, 20, 309, -1, 335, 25, 622, 331, 30, 70 }, // TROUT
			{ 5, 23, 305, -1, 341, 30, 621, 363, 35, 100 }, // BASS + COD
			{ 6, 25, 309, 313, 349, 50, 622, -1, -1, -1 }, // PIKE
			{ 7, 35, 311, -1, 359, 55, 618, 371, 70, 100 }, // TUNA + SWORDIE
			{ 8, 40, 301, -1, 377, 70, 619, -1, -1, -1 }, // LOBSTER
			{ 9, 62, 305, -1, 7944, 120, 620, -1, -1, -1 }, // MONKFISH
			{ 10, 76, 311, -1, 383, 175, 618, -1, -1, -1 }, // SHARK
			{ 11, 79, 305, -1, 395, 200, 619, -1, -1, -1 }, // SEA TURTLE
			{ 12, 81, 305, -1, 389, 225, 621, -1, -1, -1 }, // MANTA RAY
			{ 13, 95, 311, -1, 12019, 300, 618, -1, -1, -1 }, // ROCKTAIL
	};
