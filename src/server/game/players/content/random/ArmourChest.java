...
public class ArmourChest {
	...
	public static final int KEY = 5585;
	...
	public static boolean canOpen(Client c) {
		if (c.getItems().playerHasItem(KEY)) {
			...
			c.sendMessage("The chest is locked. You need Armour Chest Key to unlock this chest.");
			return false;
		}
	}
		...
		if (canOpen(c)) {
			...
			EventManager.getSingleton().addEvent(new Event() {
				public void execute(EventContainer e) {
					...
					c.sendMessage("You find a rare armour piece in the chest!");
