...
public class SkillMenu {
	...
	private static final int[][] items = {
			...
			{ 841, 843, 849, 853, 857, 1135, 861, 2499, 11235, 6522, 2501,
					9185, 15003, 15041, 10330, 4214, 2503, 4734, 9756 }, { 9759 },
			{ 4099, 6916, 6889, 7401, 3387, 4675, 10338, 4712, 11994, 15110 } };
	...
	private static final String[][] DESCRIPTION = {
			...
			{ "Mystic ", "Infinity ", "Mage's book", "Enchanted ",
					"Splitbark ", "Ancient staff", "3rd age mage", "Ahrims", "Trident of the seas", "Staff of the dead" } };
