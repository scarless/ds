...
public class AttackPlayer implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		case ATTACK_PLAYER:
			...
			boolean usingCross = c.playerEquipment[c.playerWeapon] == 9185 || c.playerEquipment[c.playerWeapon] == 15041 || c.playerEquipment[c.playerWeapon] == 15003;
			...
			if(c.getCombat().correctBowAndArrows() < c.playerEquipment[c.playerArrows] && Config.CORRECT_ARROWS && c.usingBow && !c.getCombat().usingCrystalBow() && c.playerEquipment[c.playerWeapon] != 15003 && (c.playerEquipment[c.playerWeapon] != 9185 && c.playerEquipment[c.playerWeapon] != 15041 && c.playerEquipment[c.playerWeapon] != 18357)) {
			...
			if ((c.playerEquipment[c.playerWeapon] == 9185 || c.playerEquipment[c.playerWeapon] == 15041 || c.playerEquipment[c.playerWeapon] == 15003)
