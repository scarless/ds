...
public class Barrows {
	...
	public static int Pots[] = {121, 123, 125, 127, 119, 2434, 2432, 2444};
	...
	public void checkCoffins() {
			if (c.barrowsKillCount < 5) {
				...
				Server.npcHandler.spawnNpc(c, 2026, c.getX(), c.getY()-1, 3, 0, 120, 25, 200, 200, true, true);
				c.getPA().removeAllWindows();
			} else if (c.barrowsKillCount > 5) {
	 ...
	 */
		...
		if (c.barrowsKillCount >= 4 && c.barrowsKillCount <= 10) {
			if (Misc.random(6) == 1) 
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.barrowsKillCount >= 6 && c.barrowsKillCount <= 12) {
			if (Misc.random(4) == 1) 
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.barrowsKillCount >= 13 && c.barrowsKillCount <= 20) {
			if (Misc.random(3) == 1) 
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.barrowsKillCount >= 20  && c.barrowsKillCount <= 26) {
			if (Misc.random(2) == 1) 
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.barrowsKillCount >= 30) {
				c.getItems().addItem(randomBarrows(), 1);
		}
	}
	...
	public void useChest() {
		...
		if (c.barrowsKillCount == 5) {
			if (c.barrowsNpcs[4][1] == 0) {
				Server.npcHandler.spawnNpc(c, 2026, c.getX(), c.getY()-1, 0, 0, 120, 25, 200, 200, true, true);
			}
			c.barrowsNpcs[4][1] = 1;
		}
